...
def analisar_abstract_com_ia(titulo, abstract, api_key, lang='pt'):
    ...
    try:
        ...
        # LÓGICA DE INFERÊNCIA SÊNIOR: Se o texto for curto, infere pelo título
        ...
        AÇÃO: Se o resumo estiver incompleto, use o TITULO para inferir o mecanismo farmacológico.
        ...
        if "429" in str(e): return f"💡 Inferência: {titulo} (Cota excedida, aguarde 1 min)"
...
# FUNÇÃO QUE ESTAVA CAUSANDO O ERRO (Garantindo o nome correto)
...
def buscar_todas_noticias(lang='pt'):
    try:
        query = "(bladder OR detrusor) AND (pharmacology OR oxidative stress)"
