...
PRESETS_FRONTEIRA = {
    "🧪 Chaperonas & Estresse": ["Trehalose", "TMAO", "4-PBA", "Taurine", "Betaine", "Chemical Chaperones"],
    "🔥 Gasotransmissores": ["Carbon Monoxide (CO)", "HO-1", "Hydrogen Sulfide (H2S)", "CBS", "CSE", "GYY4137"],
    "⚡ Mecanossensores & Canais": ["Piezo1", "Piezo2", "TRPA1", "TRPM8", "TRPV4", "P2X3", "P2X7"],
    "🧬 Epigenética & RNAs": ["TET2", "HDAC6 inhibitor", "DNMT1", "MALAT1", "miR-29b", "miR-132"],
    "🥑 Resolução & Lipídios": ["Resolvin D1", "Resolvin E1", "Maresin-1", "Lipoxin A4", "Anandamide (AEA)", "2-AG"],
    "👻 Receptores Órfãos": ["GPR35", "GPR84", "GPR68", "OR51E2", "TAS2R14"]
}
